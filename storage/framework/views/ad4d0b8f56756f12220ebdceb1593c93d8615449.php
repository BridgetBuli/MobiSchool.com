...
<header   class="header-section ">
 <!-- notification panel --> 
  ...
  <div class="logdiv w3-dropdown-hover">
    ...
    <a href="<?php echo e(URL::to('/welcome')); ?>" class="w3-bar-item w3-button">Log Out</a>
    </div>
  </div>
...
<div style="margin-left:200px;" class="w3-card-4">
  ...
  <div class="w3-row">
    ...
    <?php $__currentLoopData = $books; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      ...
      <?php if( $book->resource_type === "document" ): ?>
        <div class="w3-green w3-container w3-quarter w3-margin">
          <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.lib-card','data' => ['book' => $book]] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('lib-card'); ?>
...
<?php endif; ?>
  ...
  <div class="w3-row">
    ...
    <?php $__currentLoopData = $books; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      ...
      <?php if( $book->resource_type === "audio_book" ): ?>
        <div class="w3-green w3-container w3-quarter w3-margin">
          <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.lib-audio','data' => ['book' => $book]] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('lib-audio'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
...
</html><?php /**PATH D:\projects\MobiSchool.com\resources\views/pages/library.blade.php ENDPATH**/ ?>