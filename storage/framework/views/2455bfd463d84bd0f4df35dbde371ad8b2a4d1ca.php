...
<header   class="header-section ">
 <!-- notification panel --> 
    <?php if( session()->has( 'success' ) ): ?>
      ...
      <?php if(auth()->guard( 'educator' )->check()): ?>

        <div id="id01" class="w3-container w3-light-gray">
          <p class="w3-center" style="padding-top:10px;">
          <b> <?php echo e(session('success')); ?> <?php echo e(auth()->guard('educator')->user()->name); ?> </b> 
...
<!-- <div class="container">
  <h2><?php echo e(auth('educator')->user()->name); ?></h2>
</div> -->
  <br>

<div class="w3-sidebar w3-bar-block w3-light-grey w3-card">
  <h2 class="w3-center"><?php echo e(auth('educator')->user()->name); ?>s' Dashboard</h2>
  <br>
...
<div id="Schedule" class="w3-container  tabcontent " style="display:none; height:480px;">
  ...
  <?php $__currentLoopData = auth('educator')->user()->lesson; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lesson): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    
    <?php if( $lesson->repo->count() === 0 ): ?>
      
      <div class="w3-card" style="background-color: orange; margin-bottom: 2%">
      <?php echo e($lesson->module->course->name); ?>
...
</html><?php /**PATH D:\projects\MobiSchool.com\resources\views/pages/thdashboard.blade.php ENDPATH**/ ?>