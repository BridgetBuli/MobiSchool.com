...
<div id="id0<?php echo e($book->id); ?>" class="w3-modal w3-animate-zoom" style="height: 100%;">
  <div class="w3-modal-content">
    <div class="w3-container">
      ...
      <h3><?php echo e($book->name); ?></h3>
      <audio controls>
        <source src="<?php echo e(Storage::url( $book->url )); ?>" type="audio/mpeg">
        Your browser does not support the audio element.
      </audio>
    </div>
  </div>
</div><?php /**PATH D:\projects\MobiSchool.com\resources\views/components/lib-audio.blade.php ENDPATH**/ ?>