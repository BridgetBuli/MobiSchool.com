...
<header   class="header-section ">
 <!-- notification panel --> 
    ...
    <div class="w3-left">
        <div class="logo">
        <a style='color:#ffffff;' href="<?php echo e(URL::to('/welcome')); ?>">MobiSchool</a>
    </div>
    </div>
 ...
 <!--log in & sign up -->
            ...
            <div class="logdiv"> 
              <a href="<?php echo e(URL::to('/homepage')); ?>" class="login-panel"><i class="fa fa-user"></i>Login</a>
              <a href="<?php echo e(URL::to('/thdashboard')); ?>">Sign Up</a>
            </div>
...
<div style='background-color:#' class="container">
              <div class="row">
                  <div class="">
                  <h2> Free Tertiary School Education</h2> 
...
<div class="w3-container">
    <div  class=" w3-card w3-third col-lg-4 col-md-4">
  <h3>Certificate in Accounting</h3>
  ...
  <div class="w3-padding-16">
    ...
    <div  class="w3-card w3-third col-lg-4 col-md-4">
  <h3>Certificate in Mathematics</h3>
  <p>has 2 classes, 50+ subjects [more content]...</p>
  <div class="w3-padding-16">
             <button >Get Started</button>
 </div>
...
</html><?php /**PATH D:\projects\MobiSchool.com\resources\views/pages/tertiary.blade.php ENDPATH**/ ?>