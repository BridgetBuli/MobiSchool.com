 ...
 <?php if( session()->has( 'success' ) ): ?>
      ...
      <?php if(auth()->guard( 'student' )->check()): ?>
        ...
        <div id="id01" class="w3-container w3-light-gray">
          ...
          <b> <?php echo e(session('success')); ?> <?php echo e(auth()->guard('student')->user()->name); ?> </b> 
...
<div class="w3-container">
  <h2>Greeting, <?php echo e(auth('student')->user()->name); ?></h2>
</div>
<br>
...
<div style="margin-left:200px;" class="w3-card-4">
  ...
  <?php echo e(Storage::disk( 'local' )->path( 'Chapter8-HamiltonianPathsandCycles.pdf' )); ?>
...
</html><?php /**PATH D:\projects\MobiSchool.com\resources\views/pages/stdashboard.blade.php ENDPATH**/ ?>